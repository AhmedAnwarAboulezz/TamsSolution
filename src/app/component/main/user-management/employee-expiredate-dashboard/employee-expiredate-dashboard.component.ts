...
@Component({
  selector: 'app-employee-expiredate-dashboard',
  templateUrl: './employee-expiredate-dashboard.component.html',
  styleUrls: ['./employee-expiredate-dashboard.component.scss']
})
export class EmployeeExpiredateDashboardComponent extends BaseListComponent implements OnInit {
  ...
  tableData = {
    name: 'employees.EmployeeExpiredate',
    componentName: 'EmployeeExpiredateDashboardComponent'
  };
