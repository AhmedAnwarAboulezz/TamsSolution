...
@Component({
  selector: 'app-uncomplete-employee-dashboard',
  templateUrl: './uncomplete-employee-dashboard.component.html',
  styleUrls: ['./uncomplete-employee-dashboard.component.scss']
})
export class UncompleteEmployeeDashboardComponent extends BaseListComponent implements OnInit {
  ...
  tableData = {
    name: 'employees.uncompleteEmployeedata',
    componentName: 'UncompleteEmployeeDashboardComponent'
  };
